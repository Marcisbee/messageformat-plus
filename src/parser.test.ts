...
const stringCases: StringCase[] = [
  ...
  ["{}", '"{}"'],
  ["{test}", 'v["test"]'],
  ["{test.nested}", 'this.p(v,["test","nested"])'],
  [
    "{test.nested,pipe1}",
    'this.d["pipe1"](this.p(v,["test","nested"]),this.l)',
  ],
  [
    "{test.nested,pipe1,arg1}",
    'this.d["pipe1"](this.p(v,["test","nested"]),this.l,["arg1"])',
  ],
  [
    "{a, b, c{d} e{ {f} g{h} } i{j}}",
    'this.d["b"](v["a"],this.l,["c","{",["d"],"}"," ","e","{",[" ",v["f"]," ","g",v["h"]," "],"}"," ","i","{",["j"],"}"])',
  ],
  [
    "Hello {input.first_name} {input.last_name}!",
    '"Hello "+this.p(v,["input","first_name"])+" "+this.p(v,["input","last_name"])+"!"',
  ],
  [
    "{input.data.agents[context.repeater_index].name}",
    'this.p(v,["input","data","agents",this.p(v,["context","repeater_index"]),"name"])',
  ],
  [
    "{a.b[c[d.e[f].g]].h}",
    'this.p(v,["a","b",this.p(v,["c",this.p(v,["d","e",v["f"],"g"])]),"h"])',
  ],
];
